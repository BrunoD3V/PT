    ...
    public class PastoralInitializer : DropCreateDatabaseIfModelChanges<PastoralContext>
    {
        protected override void Seed(PastoralContext Context)
        {
            ...
            var pois = new List<Poi>
            {
                ...
                new Poi { PoiID=9, nome="Igreja de São Miguel Arcanjo", CategoriaID = 1, latitude=41.4124905, longitude=-7.1734237, descricao="Arquitectura religiosa, barroca e rococó. Fachada principal em empena recortada, com portal em arco abatido, sobrepujado por nicho concheado ladeado por dois óculos elípticos.Retábulos laterais rococó, sendo os colaterais, em ângulo, e o mor revivalistas neobarrocos.", imagem="", resumo="" },
